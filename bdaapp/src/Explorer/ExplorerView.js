...
const fetchFiles = async (folderId, section) => {
  ...
  // Use folder route if a folderId is provided
  if (folderId) {
  ...
  try {
    ...
    if (res.ok) {
      ...
      if (makePublic && data.publicLinkId) {
        ...
        // You could copy to clipboard or show in UI here
      }
    } else {
                ...
                >
                  ...
                  <div className="right">
                    <div className="file-actions">
                      ...
                      <IconButton onClick={() => { setSelectedNode(folder); setShowShareModal(true);}} title="Share">  <ShareIcon />
                      </IconButton>
